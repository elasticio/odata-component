...
const {
  ...
  BasicAuthRestClient,
  ApiKeyRestClient,
} = require('./commons/authentication/statelessAuthenticationRestClients');
  ...
  constructor(emitter, cfg) {
    ...
    switch (cfg.auth.type) {
      case 'No Auth':
        ...
        break;
      case 'Basic Auth':
        authenticatedRestClient = new BasicAuthRestClient(emitter,
          cfg,
          cfg.auth.basic.username,
          cfg.auth.basic.password);
        break;
      case 'API Key Auth':
        authenticatedRestClient = new ApiKeyRestClient(emitter,
          cfg,
          cfg.auth.apiKey.headerName,
          cfg.auth.apiKey.headerValue);
        break;
      default:
