...
module.exports = class ODataClient {
  ...
  static deleteObjectFactory(oDataClientClass) {
  ...
  async deletObject(msg)
   {
    console.log(`Call delete object ${msg}`);
  ...
  async getDeleteObject() {
      ...
      console.log("Delete object called "+linkResults.value);
    return  linkResults.value;
